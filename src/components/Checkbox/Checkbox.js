...
export default class Checkbox extends TouchableOpacity {
  ...
  static defaultProps = {
    ...
    size: 'md',
    checkedIcon: require('./icon/checked.png'),
    uncheckedIcon: require('./icon/unchecked.png'),
  ...
  buildProps() {
    ...
    switch (size) {
      case 'lg':
        iconSize = Default.cbIconSizeLG;
        textFontSize = Default.cbFontSizeLG;
        textPaddingLeft = Default.cbTitlePaddingLeftLG;
        break;
      case 'sm':
        iconSize = Default.cbIconSizeSM;
        textFontSize = Default.cbFontSizeSM;
        textPaddingLeft = Default.cbTitlePaddingLeftSM;
        break;
      default:
        iconSize = Default.cbIconSizeMD;
        textFontSize = Default.cbFontSizeMD;
        textPaddingLeft = Default.cbTitlePaddingLeftMD;
    }
    ...
    let iconStyle = [{
      tintColor: checked ? Default.cbCheckedTintColor : Default.cbUncheckedTintColor,
      width: iconSize,
      height: iconSize,
    }].concat(checked ? checkedIconStyle : uncheckedIconStyle);
    let textStyle = [{
      color: Default.cbTitleColor,
  ...
  render() {
    ...
    if (this.props.disabled) {
      return (
        <View style={{opacity: Default.cbDisabledOpacity}}>
          {super.render()}
        </View>
      );
    } else {
